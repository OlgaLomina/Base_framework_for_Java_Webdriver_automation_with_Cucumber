...
public class RestStepDefs {
    ...
    public void iCreateViaRESTPosition(String type) {
        new RestClient().createPosition(getPositionForRest(type));
    }
    ...
    public void iVerifyViaRESTNewPositionIsInTheList(String type) {
        ...
        Map<String, String> expectedPosition = getPositionForRest(type);
    ...
    public void iUpdateViaRESTPosition(String type) {
        Map<String, String> updatedPosition = getPositionForRest(type + "_updated");
    ...
    public void iVerifyViaRESTNewPositionIsUpdated(String type) {
        ...
        Map<String, String> expectedFields = getPositionForRest(type + "_updated");
